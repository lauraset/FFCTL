...
def main():
    ...
    logdir = os.path.join(iroot, fcode+'_1ta_cert')
    ...
    # old version
    pretrainp = os.path.join(iroot2, 'res50build_update', 'scratch', 'model_best.tar') # load pretrained model
    ...
    for epoch in range(epochs-start_epoch):
        ...
        # save every epoch
        is_best = test_iou > best_acc
        best_acc = max(test_iou, best_acc)  # update
