function est_im = Color_Transfer_CCS_multi(source,target)
...
%
b = size(source,3);
rgb_s = reshape(im2double(source),[], b)';
rgb_t = reshape(im2double(target),[], b)';
...
% translations
T_t = eye(b+1); T_t(1:b,b+1) =  mean_t; %Target Image
T_s = eye(b+1); T_s(1:b,b+1) = -mean_s; %Source Image
% rotations
